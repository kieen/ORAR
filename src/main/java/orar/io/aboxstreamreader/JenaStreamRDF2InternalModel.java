...
//		logger.info("" + subject + ", " + predicate + "," + object);
	...
	private void addClassAssertion(Node subject, Node object) {
		...
		int individualIndex = indexer.getIndexOfIndividualStringID(subject.toString());
	...
	private void addObjectPropertyAssertion(Node subject, Node predicate, Node object) {
		...
		int subjectIndex = indexer.getIndexOfIndividualStringID(subject.toString());

		int objectIndex = indexer.getIndexOfIndividualStringID(object.toString());
