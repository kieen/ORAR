...
public abstract class OntologyReaderTemplate implements OntologyReader {
	...
	public OrarOntology getNOTNormalizedOrarOntology(String tboxFileName, String aboxListFileName) {
		long startParsing = System.currentTimeMillis();
		// /*
		// * clear old indexing if there is
		// */
	...
	public OrarOntology getNOTNormalizedOrarOntology(String ontologyFileName) {
		long startParsing = System.currentTimeMillis();
		// /*
		// * clear old indexing if there is
		// */
