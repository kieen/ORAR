...
public class HornSHIF_Materializer_KoncludeOptimized extends HornSHIF_MaterializerOptimized {
	...
	public HornSHIF_Materializer_KoncludeOptimized(OrarOntology normalizedOrarOntology) {
		super(normalizedOrarOntology);

	}

	public HornSHIF_Materializer_KoncludeOptimized(OrarOntology normalizedOrarOntology, int port) {
		super(normalizedOrarOntology);
		this.port = port;
	}
