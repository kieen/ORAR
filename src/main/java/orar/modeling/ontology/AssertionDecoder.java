...
public class AssertionDecoder {
	private static IndividualIndexerInterface indexer = IndividualIndexerUsingMapAndList.getInstance();
	 ...
	 * @return OWLAPI concept assertion of the individual whose index number is
	 *         {@code individualLong}
	 */
	 ...
	 * @param subjectLong
	 * @param objectLong
	 * @return OWLAPI role assertion of the subject whose index number is
	 *         {@code subjectLong} and object whose index number is
	 *         {@code objectLong}
	 */
	public static OWLObjectPropertyAssertionAxiom getOWLAPIRoleAssertion(OWLObjectProperty owlapiRole,
			Integer subjectLong, Integer objectLong) {
	 ...
	 * @return OWLAPI sameas assertions of individuals whose index numbers are
	 *         {@code individualsInLong}
	 */
	...
	public static Map<OWLNamedIndividual, Set<OWLNamedIndividual>> getSameasMapInOWLAPI(
			Map<Integer, Set<Integer>> encodedSameasMap) {
