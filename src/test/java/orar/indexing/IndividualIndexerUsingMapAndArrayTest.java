...
public class IndividualIndexerUsingMapAndArrayTest {
	...
	public void test() {
		...
		for (int i = 1; i <= 5; i++) {
			...
			System.out.print(s + " --> ");
			System.out.println(indexer.getIndexOfIndividualStringID(s));
		}

		int indexOfInd1 = indexer.getIndexOfIndividualStringID(ind1);
		Assert.assertEquals(0, indexOfInd1);

		int indexOfInd2 = indexer.getIndexOfIndividualStringID(ind2);
		Assert.assertEquals(1, indexOfInd2);

		int indexOfInd3 = indexer.getIndexOfIndividualStringID(ind3);
		Assert.assertEquals(2, indexOfInd3);

		int indexOfInd4 = indexer.getIndexOfIndividualStringID(ind4);
		Assert.assertEquals(3, indexOfInd4);

		int indexOfInd5 = indexer.getIndexOfIndividualStringID(ind5);
